...
<form method="POST" action="/profesor/{{$prof->id}}">
@method('put')
@csrf
...
<div>
    <label>Nombre :</label>
    <input type="text" name="name" placeholder="Juan" value="{{$prof->nom}}" >
</div>
<div>
    <label>Apellidos :</label>
    <input type="text" name="surname" placeholder="Lopez" value="{{$prof->cognom}}">
</div>
<div>
    <label>Email : </label>
    <input type="text" name="email" placeholder="prueba@correo.es" value="{{$prof->email}}" >
</div>
<div>
